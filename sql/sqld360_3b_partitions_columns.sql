...
BEGIN
  ...
  LOOP
    ...
    LOOP
      ...
      put('&&sqld360_skip_lowhigh.        WHEN data_type IN (''''VARCHAR2'''', ''''CHAR'''') THEN to_char(utl_raw.cast_to_varchar2(a.low_value)) ');
      put('&&sqld360_skip_lowhigh.        WHEN data_type IN (''''NVARCHAR2'''',''''NCHAR'''') THEN to_char(utl_raw.cast_to_nvarchar2(a.low_value)) ');
      ...
      put('&&sqld360_skip_lowhigh.        WHEN data_type IN (''''VARCHAR2'''', ''''CHAR'''') THEN to_char(utl_raw.cast_to_varchar2(a.high_value)) ');
      put('&&sqld360_skip_lowhigh.        WHEN data_type IN (''''NVARCHAR2'''',''''NCHAR'''') THEN to_char(utl_raw.cast_to_nvarchar2(a.high_value)) ');
