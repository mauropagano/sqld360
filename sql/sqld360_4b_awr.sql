...
SELECT MIN(a.snap_id) snap_id, 
       TO_CHAR(a.begin_interval_time, ''YYYY-MM-DD HH24:MI'')  begin_time, 
       TO_CHAR(a.end_interval_time, ''YYYY-MM-DD HH24:MI'')  end_time,
       NVL(TRUNC(SUM(b.buffer_gets_total/NVL(NULLIF(executions_total,0),1)),3),0) buffer_gets,
       0 dummy_02, 
       0 dummy_03,
       0 dummy_04,
       0 dummy_05,
...
SELECT MIN(a.snap_id) snap_id, 
       TO_CHAR(a.begin_interval_time, ''YYYY-MM-DD HH24:MI'')  begin_time, 
       TO_CHAR(a.end_interval_time, ''YYYY-MM-DD HH24:MI'')  end_time,
       NVL(TRUNC(SUM(b.rows_processed_total/NVL(NULLIF(executions_total,0),1)),3),0) rows_processed,
       0 dummy_02, 
       0 dummy_03,
       0 dummy_04,
       0 dummy_05,
