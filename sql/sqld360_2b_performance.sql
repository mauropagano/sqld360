...
BEGIN
 ...
 SELECT /*+ &&top_level_hints. */
       ...
       sql_profile, sql_plan_baseline, sql_patch, 
  ...
  FROM (SELECT ''MEM'' source, a.plan_hash_value, a.force_matching_signature, a.sql_profile, a.sql_plan_baseline, a.sql_patch, executions, fetches, end_of_fetch_count, elapsed_time, cpu_time, rows_processed, buffer_gets, first_load_time, last_load_time, optimizer_cost cost, optimizer_env_hash_value, min_dop, max_dop, user_io_wait_time io_time
          FROM gv$sql a,
        ...
        UNION ALL
        SELECT ''HIST'' source, a.plan_hash_value, a.force_matching_signature, a.sql_profile, ''N/A'' sql_plan_baseline, ''N/A'' sql_patch, executions_delta executions, fetches_delta fetches,  end_of_fetch_count_delta end_of_fetch_count, elapsed_time_delta elapsed_time, cpu_time_delta cpu_time, rows_processed_delta rows_processed,
